    ...
    return (
        <footer className="bg-black text-white pt-14 pb-3">
            ...
            <Wrapper className="flex justify-between mt-10 flex-col md:flex-row gap-[10px] md:gap-0">
                {/* LEFT START */}
                <div className="flex justify-between text-[12px] text-white/[0.5] hover:text-white cursor-pointer text-center md:text-left ">
                    <div>© 2023 Nike, Inc. designed by Bisheshwor </div>
                </div>
                {/* LEFT END */}
